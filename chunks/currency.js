window.onload = function(){ // Once loaded
    if (typeof(geoip_country_code) === 'function') { // If GeoIP is working
        var country = geoip_country_code(); // Set the country so we don't execute it every time.
